...
export function BrandMark({ className = "h-7 w-7" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden fill="currentColor">
      <g transform="translate(6.811 3.2) scale(0.071508)">
        ...
        <circle cx="191.65" cy="155.3" r="42" fill="var(--accent-ui, var(--hot, #ff2bd6))" />
      </g>
    </svg>
  );
}
